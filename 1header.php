  ...
  <div class="nav-container img-z-index">
        ...
        <div class="row">
          ...
          <div class="col-md-12 d-flex align-items-center">
            ...
            <div class="btn btn-sm navbar-btn mx-1"><i class="fas fa-phone"></i> <a href="tel:+1 213 318 4345"
                class="text-white text-decoration-none">+1
                213 318 4345</a></div>
    ...
    <nav class="navbar navbar-expand-sm navbar-light" id="neubar">
      ...
      <div class="container">
        ...
        <a id="logo" href="<?= get_bloginfo('wpurl') ?>"><img src="<?php bloginfo('template_directory'); ?>/images/paper-perk-logo-1.png" alt="paper-perk-logo-01" /> </a>
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu mt-1" aria-labelledby="navbarDropdownMenuLink">
                ...
                <li><a class="dropdown-item" href="<?= get_bloginfo('wpurl') ?>/services/coursework-writing-service">Coursework Writing Service</a></li>
                 <li><a class="dropdown-item" href="<?= get_bloginfo('wpurl') ?>/services/pay-for-dissertation">Pay For Dissertation</a></li>
